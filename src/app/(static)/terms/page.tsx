...
export default function TermsPage() {
  return (
    <>
      ...
      <h1>DeFiScan; Important Disclaimers</h1>
      ...
      <h1>Limitation of liability; indemnification</h1>
      ...
      <div>
        ...
        <p>
          ...
          <strong>IP Rights</strong>") in any way related to DeFiScan and
          nothing in these Terms or the wider communication of the Collective
          with respect to the DeFiScan should be understood as an assignment of
          any IP Rights or any license other than what is outlined in the
          section above to any User.
        </p>
      ...
      <h1>Supporting the Collective</h1>
